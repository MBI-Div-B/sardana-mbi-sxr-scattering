...
class FluencePseudoMotorController(PseudoMotorController):
    ...
    axis_attributes = {
        "pumpHor": {
            Type: float,
            Description: "beam diameter horizontal FWHM in um",
            DefaultValue: 0.01,
            Memorized: Memorize,
        },
        "pumpVer": {
            Type: float,
            Description: "beam diameter vertical FWHM in um",
            DefaultValue: 0.01,
            Memorized: Memorize,
        },
        "refl": {
            Type: float,
            Description: "sample reflectivity",
            DefaultValue: 0,
            Memorized: Memorize,
        },
        "repRate": {
            Type: float,
            Description: "laser repetition rate",
            DefaultValue: 3000,
            Memorized: Memorize,
        },
    }
